...
var db  = firebase.firestore();
  ...
  /*
      ...
      function initApp() {
        ...
        document.getElementById('quickstart-sign-up').addEventListener("DOMContentLoaded", 'click', handleSignUp, false);
        document.getElementById('quickstart-verify-email').addEventListener("DOMContentLoaded", 'click', sendEmailVerification, false);
