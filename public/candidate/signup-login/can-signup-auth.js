...
/*
      ...
      function initApp() {
        ...
        firebase.auth().onAuthStateChanged(function(user) {
          ...
          document.getElementById('can-sign-up-button').disabled = true;
          // [END_EXCLUDE]
          if (user) {
            // User is signed in.
            ...
            if (!emailVerified) {
              document.getElementById('can-sign-up-button').disabled = false;
            }
            // [END_EXCLUDE]
          } else {
            // User is signed out.
        ...
        //document.getElementById('can-sign-up-button').addEventListener("DOMContentLoaded", 'click', handleSignUp, false);
        //document.getElementById('can-sign-up-button').addEventListener("DOMContentLoaded", 'click', sendEmailVerification, false);
